...
Одиночный Ярославль с полным покрытием — законный ответ. Жёсткий SC-B1: пара
существует в places[] с полным покрытием + SC-B3. «Пара в топ-5» — smoke на
фикстурах, не гейт, не обещание после волны 1; веса под топ-5/ #1 не подгонять,
храмы Ярославля не вырезать.
Регресс SC-B1/SC-B2 hard — живой проход дисков, `DELETE FROM cluster` после загрузки фикстур.
...
Первый сквозной /places → /price. Критерий: hard SC-B1 (пара существует) +
SC-B3 + hard SC-B2; SSE по одному; цена fixture-confirmed; волна 1
потока A готова к подмене фикстур. «Пара в топ-5» не валит G10. Собираешь его ты, не откладывай на час 44.
